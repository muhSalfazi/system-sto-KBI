                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                            <div class="logo-wrapper text-center py-3">
                                <img src="{{ asset('assets/img/kyoraku-baru.png') }}" loading="lazy" alt="Logo Kyoraku"
                                    class="logo-auth">
                            </div>
                            <!-- End Logo -->
                            ...
                            <div class="card mb-3">
                                <div class="card-body">
                                    ...
                                    <form class="row g-3" novalidate action="{{ route('admin.login.post') }}"
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="input-group has-validation">
                                                ...
                                                <input type="text" name="username"
                                                    ...
                                                    id="yourUsername" value="{{ old('username') }}" autocomplete="off">
                                                @error('username')
                                        ...
                                        <div class="col-12">
                                            <a href="{{ route('user.login') }}" class="btn btn-outline-secondary w-100"
